...
export function interpretFreeformLocally(message: string, stepIndex: number): FreeformInterpretation {
  ...
  return {
    ...
    assistantText: currentStep
      ? 'وصلتني. دي إجابة أو سؤال خارج الاختيارات الجاهزة — مسار الـ AI متجهز لها، ولحد ما نوصله هفضل واقف عند نفس النقطة من غير ما أفترض إجابة من عندي.'
      : 'وصلتني. السؤال الحر متجهز لمسار الـ AI؛ الترشيحات الحالية هتفضل زي ما هي لحد ما نوصله فعليًا.',
  };
}
